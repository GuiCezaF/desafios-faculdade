'''
Escreva uma função que gire uma matriz bidimensional (uma matriz) no sentido horário ou anti-horário em 90 graus
e retorne a matriz girada.
A função aceita dois parâmetros: uma matriz e uma string especificando a direção ou rotação. A direção
será "clockwise" ou "counter-clockwise"
'''
